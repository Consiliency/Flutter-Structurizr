  ...
  group('Element operations comprehensive tests', () {
    ...
    group('SoftwareSystemNode.setProperty method', () {
      ...
      test('adds complex property to software system', () {
        ...
        final updatedSystem = system.setProperty('metadata', {'deployed': true, 'region': 'us-west'});
        
        expect(updatedSystem.properties!['metadata'], isA<Map>());
        expect((updatedSystem.properties!['metadata'] as Map)['deployed'], isTrue);
        expect((updatedSystem.properties!['metadata'] as Map)['region'], equals('us-west'));
      });
      ...
      test('updates existing property value', () {
        ...
        final updatedSystem = systemWithProp.setProperty('status', 'Production');
