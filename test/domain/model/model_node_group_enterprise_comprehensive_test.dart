  ...
  group('Model, Group, Enterprise, Element foundation comprehensive tests', () {
    group('Model.addGroup method', () {
      test('adds group to empty model', () {
        ...
        final group = Group(id: 'group-1', name: 'Group 1');
      ...
      test('adds multiple groups to model', () {
        final model = const Model();
        final group1 = Group(id: 'group-1', name: 'Group 1');
        final group2 = Group(id: 'group-2', name: 'Group 2');
      ...
      test('handles adding group with duplicate id', () {
        final model = const Model();
        final group1 = Group(id: 'dup-id', name: 'Group 1');
        final group2 = Group(id: 'dup-id', name: 'Group 2');
    ...
    group('Model.addEnterprise method', () {
      test('adds enterprise to model with no existing enterprise', () {
        final model = const Model();
        final enterprise = Enterprise(id: 'enterprise-1', name: 'Enterprise 1');
      ...
      test('replaces enterprise when adding second enterprise', () {
        final model = const Model();
        final enterprise1 = Enterprise(id: 'enterprise-1', name: 'Enterprise 1');
        final enterprise2 = Enterprise(id: 'enterprise-2', name: 'Enterprise 2');
        
        final updatedModel = model.addEnterprise(enterprise1).addEnterprise(enterprise2);
    ...
    group('Model.addElement method', () {
      ...
      test('handling of element with existing ID', () {
        final model = const Model();
        final person1 = Person(id: 'dup-id', name: 'Person 1');
        final person2 = Person(id: 'dup-id', name: 'Person 2');
    ...
    group('Model.addImpliedRelationship method', () {
      test('adds implied relationship to model', () {
        ...
        final updatedModel = modelWithElements.addImpliedRelationship(relationship);
