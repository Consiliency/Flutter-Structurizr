...
void main() {
  group('Styles and Themes tests', () {
    ...
    test('Styles collection serialization roundtrip', () {
      ...
      expect(deserialized.elements.first.background,
          equals(const Color(0xFF1168BD)));
      ...
      expect(deserialized.relationships.first.color,
    ...
    test('RelationshipStyle merge', () {
      ...
      const overrideStyle = RelationshipStyle(
        thickness: 2,
        style: LineStyle.dashed,
      );
    ...
    test('Styles.getElementStyle with multiple matching tags', () {
      ...
      final customerPersonStyle =
          styles.getElementStyle(['Element', 'Person', 'Customer']);
    ...
    test('Styles.getRelationshipStyle with multiple matching tags', () {
      ...
      const synchronousStyle = RelationshipStyle(
        tag: 'Synchronous',
        style: LineStyle.solid,
      );

      const asynchronousStyle = RelationshipStyle(
        tag: 'Asynchronous',
        style: LineStyle.dashed,
      );
      ...
      // Test with multiple tags - should merge in tag order
      final combinedStyle =
          styles.getRelationshipStyle(['Relationship', 'Asynchronous']);
    ...
    test('Style methods for adding styles', () {
      ...
      final stylesWithBoth =
          stylesWithElement.addRelationshipStyle(relationshipStyle);
