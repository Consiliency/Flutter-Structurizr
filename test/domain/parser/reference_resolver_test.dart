...
void main() {
  group('ReferenceResolver', () {
    test('basic functionality', () {
      ...
      const user = Person(id: 'user1', name: 'User');
      const system = SoftwareSystem(id: 'system1', name: 'Banking System');
      ...
      expect(
          resolver.resolveReference('User', searchByName: true), equals(user));
      expect(resolver.resolveReference('Banking System', searchByName: true),
          equals(system));
      ...
      const container =
          Container(id: 'container1', name: 'Web App', parentId: 'system1');
    ...
    test('variable alias resolution', () {
      ...
      // Create and register some elements
      const person = Person(id: 'p1', name: 'User');
      const system = SoftwareSystem(id: 's1', name: 'Banking System');
      const container = Container(id: 'c1', name: 'Web App', parentId: 's1');
      const component = Component(id: 'comp1', name: 'API', parentId: 'c1');
      ...
      const system2 = SoftwareSystem(id: 's2', name: 'CRM System');
