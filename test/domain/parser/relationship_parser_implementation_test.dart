  ...
  group('RelationshipParser Implementation', () {
    ...
    group('parse method', () {
      ...
      test('should parse explicit relationship with arrow and technology', () {
        final tokens = tokensFromString('source -> destination "Description" "Technology"');
        final result = parser.parse(tokens);
      ...
      test('should parse implicit relationship with uses keyword', () {
        final tokens = tokensFromString('source uses destination "Description"');
        final result = parser.parse(tokens);
      ...
      test('should parse implicit relationship with uses keyword and technology', () {
        final tokens = tokensFromString('source uses destination "Description" "Technology"');
        final result = parser.parse(tokens);
      ...
      test('should handle different relationship verbs for implicit relationships', () {
        ...
        for (final verb in verbs) {
          ...
          expect(result.first.sourceId, 'source');
          expect(result.first.destinationId, 'destination');
          expect(result.first.description, verb.substring(0, 1).toUpperCase() + verb.substring(1));
        }
      });
    ...
    group('_parseExplicit method', () {
      ...
      test('should extract description correctly', () {
        final tokens = tokensFromString('source -> destination "This is a description"');
        final result = parser.parse(tokens);
      ...
      test('should extract technology correctly', () {
        final tokens = tokensFromString('source -> destination "Description" "HTTPS"');
        final result = parser.parse(tokens);
    ...
    group('_parseImplicit method', () {
      ...
      test('should handle multi-word identifiers', () {
        final tokens = tokensFromString('source system uses destination system');
        final result = parser.parse(tokens);
      ...
      test('should extract description correctly', () {
        final tokens = tokensFromString('source uses destination "Custom description"');
        final result = parser.parse(tokens);
      ...
      test('should extract technology correctly', () {
        final tokens = tokensFromString('source uses destination "Description" "REST API"');
        final result = parser.parse(tokens);
