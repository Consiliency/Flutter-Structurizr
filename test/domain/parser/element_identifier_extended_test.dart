...
void main() {
  ...
  group('ElementParser identifier generation tests', () {
    ...
    test('should generate identifier from software system name with spaces', () {
      final tokens = lexer.tokenize('softwareSystem "Payment Processing Service"');
    ...
    test('should generate identifier from software system with international characters', () {
    ...
    test('should generate unique identifiers for different elements with same name', () {
