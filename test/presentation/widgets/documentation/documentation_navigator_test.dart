...
void main() {
  ...
  // Create a test workspace with documentation
  final workspace = WorkspaceDocumentationMixin.createWorkspaceWithDocumentation(
  ...
  group('DocumentationNavigatorController', () {
    ...
    test('validates indices correctly', () {
      ...
      expect(controller.currentSectionIndex, equals(1)); // 0-based, so max is 1 for 2 sections
      
      // Test with decisions
      controller.navigateToDecision(10);
      controller.validateIndices(2, 3);
      expect(controller.currentDecisionIndex, equals(2)); // 0-based, so max is 2 for 3 decisions
      ...
      expect(emptySecController.viewMode, equals(DocumentationViewMode.decisions));
      ...
      expect(emptyDecController.viewMode, equals(DocumentationViewMode.documentation));
    });
  });
  ...
  group('DocumentationNavigator', () {
    ...
    testWidgets('renders message when no documentation', (WidgetTester tester) async {
      final emptyWorkspace = WorkspaceDocumentationMixin.createWorkspaceWithDocumentation(
        id: 2,
    ...
    testWidgets('uses history navigation buttons', (WidgetTester tester) async {
      ...
      expect(tester.widget<IconButton>(find.byIcon(Icons.arrow_back)).onPressed, isNull);
      expect(tester.widget<IconButton>(find.byIcon(Icons.arrow_forward)).onPressed, isNull);
      ...
      expect(tester.widget<IconButton>(find.byIcon(Icons.arrow_back)).onPressed, isNotNull);
      expect(tester.widget<IconButton>(find.byIcon(Icons.arrow_forward)).onPressed, isNull);
      ...
      expect(tester.widget<IconButton>(find.byIcon(Icons.arrow_back)).onPressed, isNotNull);
      expect(tester.widget<IconButton>(find.byIcon(Icons.arrow_forward)).onPressed, isNotNull);
    ...
    testWidgets('handles keyboard shortcuts for basic navigation', (WidgetTester tester) async {
      final controller = DocumentationNavigatorController();
    ...
    testWidgets('handles keyboard shortcuts for history navigation', (WidgetTester tester) async {
      final controller = DocumentationNavigatorController();
    ...
    testWidgets('handles keyboard shortcuts for view controls', (WidgetTester tester) async {
      final controller = DocumentationNavigatorController();
    ...
    testWidgets('handles home and end keys for quick navigation', (WidgetTester tester) async {
      ...
      final testWorkspace = WorkspaceDocumentationMixin.createWorkspaceWithDocumentation(
    ...
    testWidgets('handles Alt+Number keys for quick section jumps', (WidgetTester tester) async {
      // Create a test workspace with more sections for testing
      final documentationWithMoreSections = Documentation(
        sections: [
          DocumentationSection(
    ...
    testWidgets('shows keyboard shortcuts help dialog', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: DocumentationNavigator(
