...
void main() {
  group('AsciidocRenderer - Improved Tests', () {
    ...
    testWidgets('renders asciidoc content with loading indicators',
...
''';
    ...
    testWidgets('handles errors with error message and retry button',
        (WidgetTester tester) async {
    ...
    testWidgets('provides progress indicators for large documents',
        (WidgetTester tester) async {
      ...
      if (mockController.channels.containsKey('AsciidocRenderer')) {
        ...
        channel.onMessageReceived.call(const JavaScriptMessage(
            message: '{"status": "complete", "renderTime": 150}'));
      }
      await tester.pump();
    ...
    testWidgets('supports diagram embedding with callbacks',
        (WidgetTester tester) async {
...
''';
    ...
    testWidgets('applies correct theme based on isDarkMode',
        (WidgetTester tester) async {
      ...
      expect(
          loadedHtml.contains('dark-mode') ||
              loadedHtml.contains('background-color: #1a1a1a'),
          isTrue);
    ...
    testWidgets('supports content caching for performance',
        (WidgetTester tester) async {
      ...
      mockController.addToCache(
          contentHash, '<div>Rendered HTML for testing</div>');
