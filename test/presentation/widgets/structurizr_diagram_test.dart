...
void main() {
  group('StructurizrDiagram Widget', () {
    ...
    testWidgets('renders correctly with basic configuration',
    ...
    testWidgets('calls onElementSelected callback when element is tapped',
        (WidgetTester tester) async {
      ...
      await tester
          .tapAt(const Offset(350, 350)); // Position where 'system' should be
      await tester.pumpAndSettle();
    ...
    testWidgets('calls onSelectionCleared callback when background is tapped',
        (WidgetTester tester) async {
    ...
    testWidgets('disables interactions when configured',
        (WidgetTester tester) async {
      // Create a key to access the state later
      final diagKey = GlobalKey<StructurizrDiagramState>();
    ...
    testWidgets('fitToScreen centers and fits all elements',
        (WidgetTester tester) async {
      // Create a key to access the state later
      final diagKey = GlobalKey<StructurizrDiagramState>();
    ...
    testWidgets('centerOnElement focuses on specific element',
        (WidgetTester tester) async {
      // Create a key to access the state later
      final diagKey = GlobalKey<StructurizrDiagramState>();
    ...
    testWidgets('handles view and workspace changes',
        (WidgetTester tester) async {
      // Create a key to access the state later
      final diagKey = GlobalKey<StructurizrDiagramState>();
      ...
      // Create a new view
      const newView = SystemContextView(
        key: 'new-view',
        softwareSystemId: 'system',
    ...
    testWidgets('supports animation steps', (WidgetTester tester) async {
      ...
      const animatedView = SystemContextView(
        key: 'animated-view',
        softwareSystemId: 'system',
