...
void main() {
  ...
  testWidgets('Lasso selection should select elements', (WidgetTester tester) async {
    ...
    final startPoint = const Offset(50, 50);
    final dragPoints = [
      const Offset(150, 50),
  ...
  testWidgets('Multiple selection with lasso should update selection state', (WidgetTester tester) async {
    // Create a simple view with two elements
    final view = SystemContextView(
      key: 'test',
      softwareSystemId: 'system1',
    ...
    final startPoint = const Offset(50, 50);
    final endPoint = const Offset(600, 250);
  ...
  testWidgets('Lasso selection with keyboard modifiers combines selections', (WidgetTester tester) async {
    // Create a simple view with two elements
    final view = SystemContextView(
      key: 'test',
      softwareSystemId: 'system1',
    ...
    await tester.tap(find.byType(StructurizrDiagram).first, warnIfMissed: false);
    await tester.pumpAndSettle();
    ...
    final startPoint = const Offset(350, 50);
    final endPoint = const Offset(600, 250);
  ...
  testWidgets('Lasso selection for relationships only', (WidgetTester tester) async {
    // Create a simple view with two elements
    final view = SystemContextView(
      key: 'test',
      softwareSystemId: 'system1',
    ...
    final startPoint = const Offset(200, 50);
    final dragPoints = [
      const Offset(300, 50),
  ...
  testWidgets('Lasso selection performance with many elements', (WidgetTester tester) async {
    ...
    final startPoint = const Offset(50, 50);
    final endPoint = const Offset(950, 950);
    ...
    print('Lasso selection with ${elements.length} elements took ${stopwatch.elapsedMilliseconds}ms');
  });
}