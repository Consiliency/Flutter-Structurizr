...
void main() {
  ...
  testWidgets('ExportDialog shows and has basic structure', (WidgetTester tester) async {
    // Build our widget
  ...
  testWidgets('ExportDialog updates preview on format change', (WidgetTester tester) async {
    ...
    await tester.pump();
    await tester.pumpAndSettle(const Duration(milliseconds: 600)); // Account for debounce
  ...
  testWidgets('ExportDialog updates preview when options change', (WidgetTester tester) async {
    // Create a mock export manager
    final mockExportManager = MockExportManager();
  ...
  testWidgets('ExportDialog handles memory efficient rendering toggle', (WidgetTester tester) async {
    // Create a mock export manager
    final mockExportManager = MockExportManager();
  ...
  testWidgets('ExportDialog shows progress during preview generation', (WidgetTester tester) async {
  ...
  testWidgets('ExportDialog handles preview generation errors', (WidgetTester tester) async {
  ...
  testWidgets('ExportDialog shows and hides format-specific options', (WidgetTester tester) async {
    // Build our widget
    await tester.pumpWidget(MaterialApp(
      home: TestableExportDialog(
        workspace: testWorkspace,
  ...
  testWidgets('ExportDialog toggle preview visibility', (WidgetTester tester) async {
    // Build our widget
    await tester.pumpWidget(MaterialApp(
      home: TestableExportDialog(
        workspace: testWorkspace,
