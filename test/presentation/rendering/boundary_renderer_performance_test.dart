...
void main() {
  group('BoundaryRenderer - Performance Tests', () {
    ...
    test('handles large number of contained elements efficiently', () {
      ...
      final expectedMinX = 50 - padding;
      final expectedMinY = 50 - padding;
      final expectedMaxX = 50 + 9 * 120 + 100 + padding; // Last element right edge + padding
      final expectedMaxY = 50 + 9 * 100 + 80 + padding; // Last element bottom edge + padding
    ...
    test('handles deeply nested boundaries efficiently', () {
      ...
      final int nestingDepth = 5; // 5 levels of nesting
    ...
    test('complex boundary rendering with all features performs adequately', () {
      ...
      final element = BasicElement.create(
        ...
        type: 'SoftwareSystem',
        description: 'This is a complex boundary with lots of styling features enabled',
      );
      ...
      final List<Rect> childRects = [
        Rect.fromLTWH(50, 70, 100, 80),
        Rect.fromLTWH(180, 70, 100, 80),
        Rect.fromLTWH(50, 170, 100, 80),
        Rect.fromLTWH(180, 170, 100, 80),
      ];
      ...
      renderer.renderBoundary(
        canvas: mockCanvas,
        element: element,
        bounds: Rect.fromLTWH(10, 20, 300, 250),
        style: style,
