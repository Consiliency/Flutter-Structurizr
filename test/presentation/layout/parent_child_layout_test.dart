...
void main() {
  group('Parent-Child Relationship Handling', () {
    test(
        'ElementView extension methods for parent-child relationships work correctly',
        () {
      // Create a parent element
      const parent = ElementView(id: 'parent1', x: 100, y: 100);

      // Create a child element
      const child =
          ElementView(id: 'child1', parentId: 'parent1', x: 150, y: 150);
    ...
    test('ForceDirectedLayout correctly handles parent-child boundaries', () {
      ...
      const child1 =
          ElementView(id: 'child1', parentId: 'parent1', x: 120, y: 120);
      const child2 =
          ElementView(id: 'child2', parentId: 'parent1', x: 180, y: 180);
      ...
      final child1Rect = Rect.fromLTWH(child1Pos.dx, child1Pos.dy,
          elementSizes['child1']!.width, elementSizes['child1']!.height);

      final child2Rect = Rect.fromLTWH(child2Pos.dx, child2Pos.dy,
          elementSizes['child2']!.width, elementSizes['child2']!.height);
      ...
      bool child1Moving =
          (child1Pos - const Offset(120, 120)).distanceSquared > 0;
      bool child2Moving =
          (child2Pos - const Offset(180, 180)).distanceSquared > 0;
    ...
    test('AutomaticLayout correctly identifies and handles boundaries', () {
      ...
      final elementViews = [
        ...
        const ElementView(
            id: 'child2',
            parentId: 'parent1'), // Another child of the same parent
        const ElementView(id: 'element1'), // Independent element
        const ElementView(id: 'element2'), // Independent element
      ];
