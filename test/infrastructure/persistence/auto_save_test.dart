...
void main() {
  ...
  setUp(() async {
    ...
    tempDir =
        await Directory.systemTemp.createTemp('flutter_structurizr_test_');
  ...
  group('AutoSave', () {
    test('should automatically save workspace when changed', () async {
      ...
      // File to save to
      final workspacePath =
          path.join(workspacesDir.path, 'auto-save-test.json');
    ...
    test('should toggle auto-save on and off', () async {
      ...
      // Update the workspace
      const updatedWorkspace1 = Workspace(
        id: 1,
        name: 'Toggle Test',
      ...
      const updatedWorkspace2 = Workspace(
        id: 1,
        name: 'Toggle Test',
      ...
      final updatedLoadedWorkspace =
          await fileStorage.loadWorkspace(workspacePath);
    ...
    test('should handle failed saves gracefully', () async {
      ...
      const invalidPath = '///?/invalid/path/error-test.json';
      ...
      final failedEvent = events.firstWhere(
        ...
        orElse: () =>
            throw StateError('Should have emitted a saveFailed event'),
      );
    ...
    test('should save immediately when requested', () async {
      ...
      final workspacePath =
          path.join(workspacesDir.path, 'immediate-save-test.json');
