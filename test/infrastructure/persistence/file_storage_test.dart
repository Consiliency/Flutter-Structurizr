...
void main() {
  ...
  group('FileStorage', () {
    test('should save and load workspace', () async {
      ...
      // Save the workspace
      final workspacePath =
          path.join(workspacesDir.path, 'test-workspace.json');
    ...
    test('should create and manage backups', () async {
      ...
      final restoredWorkspace =
          await fileStorage.restoreFromBackup(backups.first);

      // Verify the restored workspace
      expect(restoredWorkspace.id, 1);
      expect(restoredWorkspace.name, 'Test Workspace');
      expect(
          restoredWorkspace.description, 'Version 4'); // Second-to-last version
    });
    ...
    test('should handle errors gracefully', () async {
      ...
      final nonExistentPath =
          path.join(workspacesDir.path, 'does-not-exist.json');
      expect(
