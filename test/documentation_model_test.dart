...
void main() {
  group('Documentation Model', () {
    test('creates documentation with sections', () {
      ...
      expect(documentation.sections[0].format, equals(DocumentationFormat.markdown));
      expect(documentation.sections[1].title, equals('Context'));
      expect(documentation.sections[1].format, equals(DocumentationFormat.asciidoc));
    });
    ...
    test('handles special characters in content', () {
      final documentation = Documentation(
        sections: [
          DocumentationSection(
            ...
            content: 'Content with "quotes" and \\ backslashes and line\nbreaks',
            format: DocumentationFormat.markdown,
            order: 1,
          ),
        ],
      ...
      expect(documentation.decisions[0].status, equals('Accepted with "quotes"'));
