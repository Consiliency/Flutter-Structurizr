...
class DslExporter implements DiagramExporter<String> {
  ...
  void _generateMetadataSection(StringBuffer buffer, Workspace workspace) {
    ...
    if (workspace.description != null && workspace.description!.isNotEmpty) {
      buffer.writeln('${indent}description "${_escapeString(workspace.description!)}"');
    }
  ...
  void _generatePersonDefinition(StringBuffer buffer, Person person, String indentation) {
    ...
    if (person.relationships.isNotEmpty) {
      ...
      for (final relationship in person.relationships) {
        _generateRelationshipDefinition(buffer, relationship, '${indentation}${indent}');
      }
    }
  ...
  void _generateSystemDefinition(StringBuffer buffer, SoftwareSystem system, String indentation) {
    ...
    if (system.containers.isNotEmpty) {
      ...
      for (final container in system.containers) {
        _generateContainerDefinition(buffer, container, '${indentation}${indent}');
      }
    }
  ...
  void _generateContainerDefinition(StringBuffer buffer, Container container, String indentation) {
    ...
    // Add tags
    if (container.tags != null && container.tags!.isNotEmpty) {
      buffer.writeln('${indentation}${indent}tags "${_escapeString(container.tags!.join(', '))}"');
    }
    
    // Add custom properties
    if (container.properties != null && container.properties!.isNotEmpty) {
    ...
    if (container.components.isNotEmpty) {
      ...
      for (final component in container.components) {
        _generateComponentDefinition(buffer, component, '${indentation}${indent}');
      }
    }
  ...
  void _generateComponentDefinition(StringBuffer buffer, Component component, String indentation) {
    ...
    if (component.tags != null && component.tags!.isNotEmpty) {
      buffer.writeln('${indentation}${indent}tags "${_escapeString(component.tags!.join(', '))}"');
    }
  ...
  void _generateDeploymentNodeDefinition(StringBuffer buffer, DeploymentNode node, String indentation) {
    ...
    if (node.tags != null && node.tags!.isNotEmpty) {
      buffer.writeln('${indentation}${indent}tags "${_escapeString(node.tags!.join(', '))}"');
    }
    ...
    if (node.infrastructureNodes.isNotEmpty) {
      ...
      for (final infra in node.infrastructureNodes) {
        _generateInfrastructureNodeDefinition(buffer, infra, '${indentation}${indent}');
      }
    }
    ...
    if (node.containerInstances.isNotEmpty) {
      ...
      for (final instance in node.containerInstances) {
        buffer.writeln('${indentation}${indent}containerInstance ${instance.id}');
      }
    }
    ...
    if (node.softwareSystemInstances.isNotEmpty) {
      ...
      for (final instance in node.softwareSystemInstances) {
        buffer.writeln('${indentation}${indent}softwareSystemInstance ${instance.id}');
      }
    }
    ...
    if (node.children.isNotEmpty) {
      ...
      for (final child in node.children) {
        _generateDeploymentNodeDefinition(buffer, child, '${indentation}${indent}');
      }
    }
  ...
  void _generateDynamicViewDefinition(StringBuffer buffer, DynamicView view, String indentation) {
    ...
    if (view.relationships.isNotEmpty) {
      buffer.writeln('${indentation}${indent}# relationships');
      for (final rel in view.relationships) {
        buffer.write('${indentation}${indent}${rel.sourceId} -> ${rel.destinationId}');
  ...
  void _generateDeploymentViewDefinition(StringBuffer buffer, DeploymentView view, String indentation) {
  ...
  void _generateViewsConfigurationDefinition(StringBuffer buffer, Workspace workspace, String indentation) {
    buffer.writeln();
