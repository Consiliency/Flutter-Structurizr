...
class WorkspaceManagerWithHistory implements WorkspaceManager {
  ...
  @override
  Future<Workspace> createWorkspace(WorkspaceMetadata metadata, {ValueChanged<double>? onProgress}) {
  ...
  Future<void> deleteWorkspace(String path, {bool deleteBackups = true}) {
    return _workspaceManager.deleteWorkspace(path, deleteBackups: deleteBackups);
  }
  ...
  @override
  Future<void> exportWorkspace(String sourcePath, String destinationPath, {ExportFormat format = ExportFormat.json, ValueChanged<double>? onProgress}) {
    return _workspaceManager.exportWorkspace(sourcePath, destinationPath, format: format, onProgress: onProgress);
  }
  ...
  Future<void> importWorkspace(String sourcePath, String destinationPath, {ValueChanged<double>? onProgress}) {
    return _workspaceManager.importWorkspace(sourcePath, destinationPath, onProgress: onProgress);
  }
  ...
  @override
  Map<String, Workspace> get loadedWorkspaces => _workspaceManager.loadedWorkspaces;
  
  @override
  Future<Workspace> openWorkspace(String path, {ValueChanged<double>? onProgress}) {
    return _workspaceManager.openWorkspace(path, onProgress: onProgress);
  }
  
  @override
  List<WorkspaceMetadata> get recentWorkspaces => _workspaceManager.recentWorkspaces;
  
  @override
  Future<Workspace> restoreFromBackup(WorkspaceBackup backup, {bool overwriteOriginal = true, ValueChanged<double>? onProgress}) {
    return _workspaceManager.restoreFromBackup(backup, overwriteOriginal: overwriteOriginal, onProgress: onProgress);
  }
  
  @override
  Future<void> saveWorkspace(String path, {Workspace? workspace, bool createBackup = true, ValueChanged<double>? onProgress}) {
    return _workspaceManager.saveWorkspace(path, workspace: workspace, createBackup: createBackup, onProgress: onProgress);
  }
  ...
  @override
  Stream<WorkspaceEvent> get workspaceEvents => _workspaceManager.workspaceEvents;
  
  @override
  Future<void> closeWorkspace(String path, {bool saveBeforeClosing = true, ValueChanged<double>? onProgress}) {
    return _workspaceManager.closeWorkspace(path, saveBeforeClosing: saveBeforeClosing, onProgress: onProgress);
  }
  ...
  void updateWorkspace(String path, Workspace workspace) {
    ...
    final command = WorkspaceUpdateCommand(
      currentWorkspace,
      workspace,
      (updatedWorkspace) => _workspaceManager.updateWorkspace(path, updatedWorkspace),
      'Update workspace',
    );
  ...
  void addContainer(String path, String parentSystemId, Container container) {
    final workspace = _workspaceManager.loadedWorkspaces[path];
    if (workspace == null) return;
  ...
  void addComponent(String path, String parentSystemId, String parentContainerId, Component component) {
    final workspace = _workspaceManager.loadedWorkspaces[path];
    if (workspace == null) return;
  ...
  void updateViewPositions(String path, String viewKey, Map<String, Offset> oldPositions, Map<String, Offset> newPositions) {
    final workspace = _workspaceManager.loadedWorkspaces[path];
    if (workspace == null) return;
  ...
  void updateDocumentation(String path, Documentation? oldDocumentation, Documentation newDocumentation) {
    final workspace = _workspaceManager.loadedWorkspaces[path];
    if (workspace == null) return;
  ...
  void removeElement(String path, Element element, {
