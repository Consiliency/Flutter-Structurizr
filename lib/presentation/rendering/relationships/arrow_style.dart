...
class ArrowStyle {
  ...
  Path createStandardArrowhead(
    ...
    final point1 = _calculatePointOnCircle(endPoint, angle + math.pi * 0.8, size);
    final point2 = endPoint;
    final point3 = _calculatePointOnCircle(endPoint, angle - math.pi * 0.8, size);
  ...
  Path createDiamondArrowhead(
    ...
    final point2 = _calculatePointOnCircle(endPoint, angle + math.pi/2, size * 0.5);
    final point3 = _calculatePointOnCircle(endPoint, angle + math.pi, size);
    final point4 = _calculatePointOnCircle(endPoint, angle - math.pi/2, size * 0.5);
  ...
  Path createCircleArrowhead(
    ...
    final circleCenter = _calculatePointOnCircle(endPoint, angle + math.pi, size);
