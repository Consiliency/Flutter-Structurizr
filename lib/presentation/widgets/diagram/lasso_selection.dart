...
class LassoSelection {
  ...
  Set<String> get selectedRelationshipIds =>
      Set.unmodifiable(_selectedRelationshipIds);
  ...
  bool _lineIntersectsLine(Offset a, Offset b, Offset c, Offset d) {
    ...
    if (ccw1 == 0 && ccw2 == 0 && ccw3 == 0 && ccw4 == 0) {
      ...
      return _isOverlapping(a.dx, b.dx, c.dx, d.dx) &&
          _isOverlapping(a.dy, b.dy, c.dy, d.dy);
    }
