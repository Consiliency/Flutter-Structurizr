...
class _AnimationControlsState extends State<AnimationControls> with SingleTickerProviderStateMixin {
  /// Current animation step index
  ...
  int get _maxStepIndex => widget.animationSteps.isEmpty ? 0 : widget.animationSteps.length - 1;
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = widget.config.backgroundColor ?? Colors.black.withOpacity(0.1);
    ...
    final inactiveColor = widget.config.inactiveColor ?? colorScheme.onSurface.withOpacity(0.3);
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: widget.animationSteps.isEmpty ? null : _goToPreviousStep,
                    ...
                    IconButton(
                      ...
                      onPressed: widget.animationSteps.isEmpty ? null : _togglePlayback,
                    ...
                    IconButton(
                      ...
                      onPressed: widget.animationSteps.isEmpty ? null : _goToNextStep,
                      tooltip: 'Next Step',
                    ),
                ...
                if (widget.animationSteps.isNotEmpty) ...[
                  ...
                  if (widget.config.showTimingControls || widget.config.showModeControls)
                    Padding(
